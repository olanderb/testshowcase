...
# Define the custom CSS for a thicker and darker horizontal line under column headers
custom_css <- "
.reactable-th {
  border-bottom: 5px solid #000; /* Adjust the thickness (3px) and color (black) as needed */
}
"

# Combine the custom CSS with the reactable table
...
html_file <- "reactable_custom_style.html"
